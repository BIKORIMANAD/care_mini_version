...
if($_GET['format'] == "excel" && @$_SESSION['report']){
	...
	//echo $file_name;
		...
		$activeSheet->setCellValue("B".($row + 3), "PREPARED BY : ");
		$activeSheet->setCellValue("B".($row + 6), "");
		$activeSheet->setCellValue("B".($row + 8), "");

		
		$activeSheet->setCellValue("O".($row + 3), "APPROVED BY: "."");
		$activeSheet->setCellValue("O".($row + 6), ",");
		$activeSheet->setCellValue("O".($row + 8), " HEAD OF HEALTH CENTER."."");
