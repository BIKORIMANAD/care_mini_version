...
?>  
  <div id="w">
	...
	<!--
	  ...
	  <tr><!--
	  <td>
	  <label><input type=checkbox onclick='if($("#post_KIZIBERE").prop("checked")){$("#post").val($("#post").val() + "_1")} else{ $("#post").val($("#post").val().replace("_1","")) }' id=post_KIZIBERE name=post1 value=1>KIZIBERE</label> 
	  <label><input type=checkbox onclick='if($("#post_").prop("checked")){$("#post").val($("#post").val() + "_2")} else{ $("#post").val($("#post").val().replace("_2","")) }' name=post2 id=post_ value=2></label>
	  </td>-->
	  <td>
