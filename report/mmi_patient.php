...
if($patients){
	...
	<table class=list id=vsbl border="1" style='width:100%; font-size:30px;'>
																																												<!--	Total	85%-->
		<tr><th>No</th><th>Service</th><th>No du Voucher</th><th>Date</th><th>No du bénéficiaire</th><th>Nom et Prénom du bénéficiaire</th><th>Consultation</th><th>Examens</th><th>Imaging</th><th>Hospitalisation</th><th>Acte</th><th>Consommables</th><th>Medicaments</th><th>Autres</th><th>Total 100%</th><th>Total 85%</th></tr>
		<?php
		$t = array();
		$data = array();

		$data[] = array("No","Service","No du Voucher","Date","No du bénéficiaire","Nom et Prénom du bénéficiaire","Consultation","Examens","Imaging","Hospitalisation","Acte","Consumables","Medicaments","Autres","Total 100%","Total 85%");
	...
	if(count($data)>0){
		...
		<a href='./print_report_other.php?format=pdf' target="_blank"><img title='View in PDF' src="../images/b_pdfdoc.png" class=img_links width=30px /></a>
		<a href='./print_report_other.php?format=excel&in=mmi' target="_blank"><img title="View in EXCEL" src="../images/excel.png" class=img_links width=40px /></a>
		<?php
	}
