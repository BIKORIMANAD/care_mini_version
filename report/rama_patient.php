...
if($patients){
	...
	<table class=list id=vsbl border="1" style='width:100%; font-size:30px;'>
		...
		<tr><th>No</th><th>DATE</th><th>SERVICE</th><th>VOUCHER ID.</th>
			<th>AFFILIATION NUMBER</th><th>BENEFICIARY'S AGE</th>
			<th>BENEFICIARY'S SEX</th><th>BENEFICIARY'S NAME</th>
			<th>AFFILIATE'S NAME</th><th>AFFILIATE'S AFFECTATION</th>
			<th>COST FOR CONSULTATION</th><th>COST FOR LABORATORY</th>
			<th>COST FOR IMAGING</th><th>COST FOR HOSPITALISATION</th>
			<th>COST FOR PROCEDURES AND MATERIALS</th>
			<th>COST FOR OTHER CONSUMABLES</th><th>COST FOR MEDECINES</th>
			<th>TOTAL AMOUNT</th><th>TOTAL AMOUNT</th></tr>
			<tr><th>&nbsp</th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th>100%</th><th>100%</th><th>100%</th><th>100%</th><th>100%</th><th>100%</th><th>100%</th><th>100%</th><th>85%</th><th></th></tr>
		<?php
		$t = array();
		$data = array();
		$data[] = array("N0","DATE","SERVICE","VOUCHER ID.","AFFILIATION NUMBER","BENEFICIARY'S AGE","BENEFICIARY'S SEX","BENEFICIARY'S NAME","AFFILIATE'S NAME","AFFILIATE'S AFFECTATION","COST FOR CONSULTATION","COST FOR LABORATORY","COST FOR IMAGING","COST FOR HOSPITALISATION","COST FOR PROCEDURES AND MATERIALS","COST FOR OTHER CONSUMABLES","COST FOR MEDECINES","TOTAL AMOUNT","TOTAL AMOUNT");
		$data[] = array("","",
						"","",
						"",
						"",
		...
		for($i=0;$i<count($patients);$i++){
			...
			echo "<tr onclick='$(\".styling\").html(\"<style>#id{$i}{background-color:#e5e5e3;}</style>\");' id='id{$i}'>
				...
				//select the KIZIBEREratory fees related to this request now
	...
	if(count($data)>0){
		...
		<a href='./print_report_other.php?format=excel&in=rama' target="_blank"><img title="View in EXCEL" src="../images/excel.png" class=img_links width=40px /></a>
		<?php
	}
