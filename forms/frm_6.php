...
$info = <<<INFO
<html><head><title>TRANSIT Patients</title></head><body>
<style>
	.withborders td{
	...
	<tr>
		<td>
			<table class=inner_table width=100% style='width:100%'>
				...
				<tr>
					<td style='width:370px'></b></td>
					<td style='width:400px'></b></td>
				</tr>
				<tr>
					<td>NOMs ET PRENOM: <b>{$patient['Name']}</b></td>
					
					<td></td>
				</tr>
				<tr>
					<td>
						DOCUMENT NR: <b>{$record['DocID']}</b>
					</td>
					<td></b></td>
				</tr>
				<tr>
					<td>
						DATE DE NAISSANCE: <b>{$patient['DateofBirth']}</b>
					</td>
				</tr>
				<tr>
					<td>
						SERVICE: <b>{$service['ServiceCode']}
					</td>
				</tr>
			</table>
		</td>
