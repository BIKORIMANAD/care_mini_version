    			...
    			<td>
					...
					<form id='labo_report_frm' action='la-record-loader-custom.php' method='post' style='border:0px solid #000;'>
						...
						<table border=0 style='font-size:16px; width:100%; height:230px;'>
							<tr>
								<td><label><input onclick='if($("#checkall").prop("checked")){ $(".all_data").prop("checked",":true"); } else{ $(".all_data").removeProp("checked"); }' type=checkbox id=checkall>Exam</label></td>
								<td>Start Date</td>
								<td>End Date</td>
							</tr>
							<tr>
								...
								<td style='width:200px;'>
									<input id="date1" required type="text" name='date1' class='txtfield1' style='150px;' value = '<?= date('Y-m-d',time()) ?>' onclick='ds_sh(this,"date1")' />
								</td>
								<td style='width:200px;'>
			    			...
			    			<tr style='vertical-align:top;'>
			    				<td colspan=4>
									<div  class=labo_report  style='border:0px solid #000; width:1140px; font-size:13px; height:420px; overflow:auto;' >
										&nbsp;
									</div>
								</td>
							</tr>
