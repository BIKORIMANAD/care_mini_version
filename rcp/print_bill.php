...
$remove_tm = true; //($record['DateIn'] >= $reference_date_cat_1_no_tm)?false:true;
$check_tm_data = $insurance_info[0]['InsuranceName'] == 'CBHI' && $record['FamilyCategory'] <= 2?true:false;
$InsuranceNameData = $insurance_info[0]['InsuranceName'];
$check_tm_data_cat_1 = false;
$check_malaria_result = $check_tm_data?true:false;
$malaria_found = false;
...
// var_dump($record['DateIn'], $reference_date_cat_1_no_tm, $remove_tm, "<hr />");
