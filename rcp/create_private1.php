	  ...
	  <table border=0 class="a" style='background-color:#fff;'>
		...
		<tr>
			...
			<td>-->
				...
				<input type=text name='name' autocomplete="off" onkeyup='if(familyChief()){$("#father").val($("#name").val());}' id=name class='txtfield1' style='' /></td>
		...
		<tr>
			...
			<td class=tm_view>
				...
				<label><input type=radio id='not_paid' name='tm' value="0" />TM Not Paid</label>
			</td>
		</tr>
...
function OTHER(){
	$(".tm_view").html("\
				<label><input type=radio id='prisonner' name='tm' value='private' required/> Private</label><label><input type=radio id='checked' name='tm' value='private' required/> checked</label>\
		");
	$(".fcategory").html("");
	$(".affection_location").html("");
	$(".affection_locationdata").html("");
