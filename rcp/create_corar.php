		...
		<tr>
			...
			if($service){
				...
				foreach($service as $in){ 
					...
					echo "<label style='padding:0 10px;'><input type=radio name='service' ".($in['ServiceCode'] == "CPC"?"checked":"")." value='{$in['ServiceNameID']}' id='{$in['ServiceCode']}'>{$in['ServiceCode']}</label>"; 
					} 
			} else{
