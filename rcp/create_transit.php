...
//die;
//var_dump($_SESSION);
$insurance = formatResultSet($rslt=returnResultSet($sql="SELECT DISTINCT in_name.* from in_name, in_category, in_forms, in_price WHERE in_name.CategoryID=in_category.InsuranceCategoryID && in_name.InsuranceNameID = in_forms.InsuranceNameID && in_name.InsuranceName='TRANSIT' && in_name.InsuranceNameID = in_price.InsuranceNameID ORDER BY InsuranceCode ASC, InsuranceName DESC",$con),$multirows=true,$con);
...
<table class="ds_box" cellpadding="0" cellspacing="0" id="ds_conclass"
	...
	<tr>
	  ...
	  <h1>TRANSIT PATIENT MEDICAL DOCUMENT</h1>
	  <form method=post action="rcv_patient.php" id='rcv_patient_frm'>
	  <input type='hidden' name='rcv_patient_btn' value='save' />
	  <input id="patient_search123" autocomplete="off" type=hidden name='card_id1' class='txtfield1' style='' />
	  <input id="patient_search123" autocomplete="off" type=hidden name='card_id' class='txtfield1' style='' />
	  ...
	  <table border=0 class="a" style='background-color:#fff;'>
		<tr>
			...
			?>-->
			<input id="patient_search_123" type=hidden placeholder='Search' class='txtfield1' style='' />
		...
		<tr><td>Name:<span class=error-text>*</span></td><td>Age [<label class=as_link>yyyy-mm-dd or yyyy</label>]:</td><td>Sex<span class=error-text>*</span><!--<td>Family Chief ID Card:</td><td>Family Position:</td>-->
		</tr>
		<tr>
