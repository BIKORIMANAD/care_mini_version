...
$_consumables_ = formatResultSet($rslt=returnResultSet($sql="SELECT cn_records.ConsumableRecordID, cn_records.Date, cn_records.Quantity, cn_name.* FROM cn_records, cn_price, cn_name WHERE cn_records.MedecinePriceID = cn_price.MedecinePriceID && cn_price.MedecineNameID = cn_name.MedecineNameID && PatientRecordID='{$patient['PatientRecordID']}' ",$con),$multirows=true,$con);
// var_dump($_consumables_); echo $sql; die();
