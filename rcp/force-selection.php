...
if($patients){
	...
	<table class=list id=vsbl border="1" style='width:95%; font-size:30px; margin-top:20px; margin-left:15px;'>
		<tr><!--<th>Date</th>--><th>Assurance</th><th>Nom</th><th>Age</th><th>Sex</th><th>Chef de Famille</th><th>Code</th><th>Secteur</th><th>Cellure</th><th>Village</th></tr>
		<?php
		$printed_cards = array();
