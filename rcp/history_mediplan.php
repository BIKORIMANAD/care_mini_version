...
<table class="ds_box" cellpadding="0" cellspacing="0" id="ds_conclass"
	...
	<tr>
	  ...
	  <tr>
	  <td>
	  <label><input type=checkbox onclick='if($("#post_KIZIBERE").prop("checked")){$("#post").val($("#post").val() + "_1")} else{ $("#post").val($("#post").val().replace("_1","")) }' id=post_KIZIBERE name=post value=1>KIZIBERE</label> 
