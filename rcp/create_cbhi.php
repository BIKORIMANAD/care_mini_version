...
<table class="ds_box" cellpadding="0" cellspacing="0" id="ds_conclass"
	...
	<tr>
	  ...
	  <h1>RSSB CBHI PATIENT MEDICAL DOCUMENT <a style="color: blue; font-size: 10px;" href="../forms/frm_2.2_blank.php" target="_blank">
	 <!-- Print empty forms -->
	  </a></h1>
	  ...
	  <table border=0 style='background-color:#fff;'>
		...
		<tr class="patient_found_search">
			...
			<div class="patient_found"></div></td>
					...
					<tr>
						...
						<td style='width:100px; font-size:14px'>Beneficiary ID Number </td>
					</tr>
				</table>
		...
		<tr>
			...
			<input id="patient_search1" autocomplete="off" type="hidden" name='card_id1' class='txtfield1' style='' />
				<table border=0 style='width:200px; text-align:center;'>
					...
					<tr>
					<tr>
						<input type=text autocomplete="off"  class='txtfield1' id=pa style='width:100%; font-size:16px;' placeholder="Insurance card or National ID Number" onkeypress="return isNumberKey(event)"/>
						</td>
					</tr>
		...
		<tr><td class=h_label>Head of Household Name:<label class=as_link onclick='$("#father").val($("#name").val());$("#pa1").val($("#patient_search").val());$("#patient_search1").val($("#patient_search").val())'>Self
		</label>
		<span class=error-text>*</span></td></td><td class=fcategory>Head of Household ID Number<span class=error-text>*</td><td class=fcategory>Category<span class=error-text>*</span></td>
		<td class=affection_location></td><td class=sex></td>
		</tr>
		<tr>
			<td><input type=text name='father' autocomplete="off" id=father class='txtfield1' style='' /></td>
			<!-- National Identiication -->
			<td style='width:100px;'><input type=text autocomplete="off"  class='txtfield1' id=pa1 style='width:100%; font-size:16px;' placeholder="National ID Number" onkeypress="return isNumberKey(event)"" />
			</td>
			<!-- End of National Identification -->
...
$(document).ready(function(){
	...
	$(document).ready(function(){
		$("#father").keypress(function(event){
			var inputValue = event.which;
			//allow letters and white space
			if (event.which==8 || event.which == 46) {
				return true;
...
$(document).ready(function(){
	...
	$("#pa1").keyup(function(e){
		//setTimeout(function(e){
		$("#patient_search1").val($("#pa1").val());
		//nextField("pa",8,"name");
		//send search request if the cbhi code is completed
		if($("#pa1").val().length >= 8){
			$("#patient_search1").keyup();
		}
	});
