...
<table class="ds_box" cellpadding="0" cellspacing="0" id="ds_conclass"
	...
	<tr>
	  ...
	  <table border=0 class="a" style='background-color:#fff;'>
		...
		<tr><td>Card ID:<span class=error-text>*</span></td><td>Name:<span class=error-text>*</span></td><td>National ID:<span class=error-text>*</span></td><td>Age [<label class=as_link>yyyy-mm-dd or yyyy</label>]:</td><td>Sex<span class=error-text>*</span><!--<td>Family Chief ID Card:</td><td>Family Position:</td>-->
		</tr>
		<tr>
		...
		<tr>
			<td>
				...
				<label class=as_link_ onclick='$("#father").val(""); $("#rama_affiliate").val("Child")'><input type=radio name='ralation'>Enfant</label>
