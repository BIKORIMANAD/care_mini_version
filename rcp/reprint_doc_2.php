...
if(strlen($_GET['key'])){
	...
	<table class=list id=vsbl border="1" style='width:100%;'>
		<tr><th colspan=2>&nbsp;</th><th>#</th><th>Date</th><th>Service</th><th>TM</th><th>Name</th><th>Cat.</th><th>Ben. Ident</th><th>Age</th><th>Sex</th><th>Householder name</th><th>Householder ID</th><th>Weight</th><th>Temp.</th><th>District</th><th>Sector</th><th>Cell</th><th>Village</th></tr>
		<?php
		$service = null;
