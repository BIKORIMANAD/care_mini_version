...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>Monthly Report</h1>
      <b>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("monthly_data.php?key=" + $("#insurance").val() + "&year=" + $("#year").val() + "&month=" + $("#month").val() + "&post=" + $("#post").val() + "&filter=" + $("#filter_").val());
	});
