...
$end = strtotime($_GET['year']."-".($nextMonth)."-01");
//echo date("Y-m-d H:i:s", $end);
$end_date = date("Y-m-d", ($end - 1));
...
if($patients){
	...
	<table class=list id=vsbl border="1" style='width:100%; font-size:30px;'>
		...
		<th rowspan=2>Total Number of Patients  (Out patients & In patients)/Nombre Total de Patients (Ambulants & Hospitalises)</th>
		<th rowspan=2>Number of Indigents /Nombre d'Indigents</th>
		<th rowspan=2>Total Cost of Medical Benefits related Indigents/Cout Total des Prestations Medicales relatif aux Indigents</th>
		<th rowspan=2>Number of Indigents who didn't pay Co-payment/Nombre d'Indigents qui n'ont pas paye le Ticket Moderateur</th>
		<th rowspan=2>Co-payment not paid by Indigents /Ticket Moderateur non paye par les Indigents</th>
		<th rowspan=2>Number of Prisoners/Nombre de Prisonniers</th>
		<th rowspan=2>Total Cost of Medical Benefits related Prisoners/Cout Total des Prestations Medicales relatif aux Prisoniers</th>
		<th rowspan=2>Number of Transfer Cases/Nombre de Cas Transferes </th>
		<th rowspan=2>Number of CT Scan Cases/Nombre de Cas de Scanner</th>
		<th rowspan=2>Total Cost of CT Scan/Cout Total Scanner</th>
		...
		<th rowspan=2>Cost of Medical Procedures & Materials/Montant Actes & Consommables Medicaux 100%</th>
		<th rowspan=2>Ambulance 100%</th>
		<th rowspan=2>Cost of Other Consummables/Montant Autres Consommables Medicaux 100%</th>
		<th rowspan=2>Cost of Drugs/Montant Medicaments 100%</th>
		<th rowspan=2>Total Cost/Cout Total 100%</th>
		<th rowspan=2>Total CostCo-payment /Cout Total Ticket Moderateur</th>
		<th rowspan=2>Total Estimated Cost of Medical Benefits/ Cout Total Estimatif des Prestations =Total Cost 100% -Total Ticket Moderateur</th>
		</tr>
		...
		"Total Number of Patients  (Out patients & In patients)/Nombre Total de Patients (Ambulants & Hospitalises)",
		"Number of Indigents /Nombre d'Indigents",utf8_encode("Total Cost of Medical Benefits related Indigents/Cout Total des Prestations Medicales relatif aux Indigents"),
		"Number of Indigents who didn't pay Co-payment/Nombre d'Indigents qui n'ont pas paye le Ticket Moderateur","Co-payment not paid by Indigents /Ticket Moderateur non paye par les Indigents",
		"Number of Prisoners/Nombre de Prisonniers","Total Cost of Medical Benefits related Prisoners/Cout Total des Prestations Medicales relatif aux Prisoniers",
		"Number of Transfer Cases/Nombre de Cas Transferes",
		"Number of CT Scan Cases/Nombre de Cas de Scanner","Total Cost of CT Scan/Cout Total Scanner",
		...
		"Cost of Medical Procedures & Materials/Montant Actes & Consommables Medicaux 100%",
		"Ambulance 100%",
		"Cost of Other Consummables/Montant Autres Consommables Medicaux 100%",
		"Cost of Drugs/Montant Medicaments 100%",
		"Total Cost/Cout Total 100%",
		"Total CostCo-payment /Cout Total Ticket Moderateur",
		"Total Estimated Cost of Medical Benefits/ Cout Total Estimatif des Prestations =Total Cost 100% -Total Ticket Moderateur");
		...
		$last = count($patients); $printed_day = date("F",mktime(0,0,0,explode("-",$patients[0]['DateIn'])[1],explode("-",$patients[0]['DateIn'])[2],explode("-",$patients[0]['DateIn'])[0]));
		//echo $printed_day; die();
		for($i=0;$i<$last;$i++){
			$r = $patients[$i];
			$printed = date("F",mktime(0,0,0,explode("-",$r['DateIn'])[1],explode("-",$r['DateIn'])[2],explode("-",$r['DateIn'])[0]));
			...
			if($ho_patient){
					...
					elseif(in_array($r['DistrictID'], $zone_districts))
					{
						$ihz++;
					}
					else
			...
			if($printed != $printed_day || ($i + 1) == $last){
				$total_all = $cons_cost + $med_cost + $labo_cost + $hospitalization_cost + $act_cost +$act_cost1 ;
	...
	if(count($data)>0){
		...
		$_SESSION['header'] = array(
									...
									array("Period:"=>$start_date." - ".$end_date)
