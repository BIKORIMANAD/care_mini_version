...
?>
  ...
  <div id="w">
    <div id="content">
      <h1 style='margin-top:-55px'>RSSB CBHI UTILIZATION OF MEDICAL SERVICES</h1>
      <b>
	...
	<tr>
	 ...
	 <div id="ds" style='min-width:100px'></div></td></tr></table>
	  ...
	  <div class="patient_found" style='max-height:430px;'>
		<span class=error-text>Select Post to view CBHI UTILIZATION Report</span>
	  </div>
...
$(document).ready(function(){
	...
	$("#generate").click(function(e){
		...
		$(".patient_found").load("cbhiUti_data.php?key=" + $("#insurance").val() + "&start_date=" + $("#start_date").val() + "&end_date=" + $("#end_date").val() + "&post=" + $("#post").val() + "&filter=" + $("#filter_").val());
	});
